...
public partial class CoepdValue_Visakhapatnam : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        txtLocation.Text = "Visakhapatnam";
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        ErrorMessage.Text = "Your Information is sucessfully updated.";
        ErrorMessage.Visible = true;
        #region
        //string toMail = "venkat.coepd@gmail.com,trainings@coepd.com" + "," + OwnerEmail;
        ////string toMail = "developer2@coepd.com" + "," + OwnerEmail;
        //string Subject = "New Lead from " + txtLocation.Text + " - " + DateTime.UtcNow.AddHours(5).AddMinutes(30).ToString("dd MMM yyyy hh:mm tt");
        //string Body =
        //"New Lead Details:" + "<br>" +
