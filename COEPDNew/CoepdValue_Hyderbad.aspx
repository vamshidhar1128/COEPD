<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CoepdValue_Hyderbad.aspx.cs" Inherits="CoepdValue_Hyderbad" %>
...
<head runat="server">
    ...
    <link rel="canonical" href="https://www.coepd.com/coepdvalue_Hyderabad.html" />
                ...
                <div class="container-fluid">
                    <div class="row col-xs-12 col-sm-12 col-md-7 col-lg-7 background">
                        ...
                        <div class="left-form-row">
                           ...
                           <h1>
                                    <asp:Label ID="lblTitle" Text="Business Analyst Training Hyderabad" runat="server"> </asp:Label></h1>
                            </div>
