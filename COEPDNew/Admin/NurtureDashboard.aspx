<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="NurtureDashboard.aspx.cs" Inherits="Admin_NurtureDashboard" %>
                             ...
                             <div class="col-lg-2 col-md-3 col-sm-6">
                                <div class="mini-widget  mini-widget">
                                    ...
                                    <div class="mini-widget-footer center-align-text" style="background-color: lavender;">
                                        <asp:Button runat="server" ID="btnPreparaion" Text="View Details" OnClick="btnPreparaion_Click" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-2 col-md-3 col-sm-6">
            ...
            <asp:ChartArea Name="ChartArea1" BorderWidth="0" />  
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-6">
                                <div class="mini-widget  mini-widget">
                                    ...
                                    <div class="mini-widget-footer center-align-text" style="background-color: lavender;">
                                        <asp:Button runat="server" ID="btnProjectIntro" Text="View Details" OnClick="btnProjectIntro_Click" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-2 col-md-3 col-sm-6">
                ...
                <div class="row">
                    <div class="col-sm-offset-5 col-sm-10">
                        <asp:Button runat="server" ID="btnBack" Text="Back To Participants List" OnClick="btnBack_Click" />
                        <asp:Button runat="server" ID="btnSendToPlacement" SkinID="btnBack" Text="Go To Placement Wing" OnClick="btnSendToPlacement_Click" />
                    </div>
                </div>
                <br />
