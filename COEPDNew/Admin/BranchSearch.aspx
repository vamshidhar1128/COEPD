<%@ Page Title="" Language="C#" MasterPageFile="Admin.master" AutoEventWireup="true"
    CodeFile="BranchSearch.aspx.cs" Inherits="BranchSearch" %>
                ...
                <div class="widget-body">
                    <div class="row">
                        <div class="col-lg-3 col-md-3">
                            <asp:TextBox runat="server" ID="txtLocation" MaxLength="500" placeholder="Search By Location Name" OnTextChanged="txtLocation_TextChanged" AutoPostBack="true" ></asp:TextBox>
                        </div>
                          <div class="col-lg-3 col-md-3">
                            <asp:TextBox runat="server" ID="txtBranch" MaxLength="500" placeholder="Search By Branch Name" OnTextChanged="txtBranch_TextChanged" AutoPostBack="true"></asp:TextBox>
                        </div>
                                   ...
                                   <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="150px">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEdit" runat="server" SkinID="edit" CommandName="cmdEdit"
                                            CommandArgument='<%#Eval("BranchId")%>'></asp:LinkButton>
                                        <%--<asp:LinkButton ID="lnkDelete" runat="server" SkinID="delete" CommandName="cmdDelete"
                                            CommandArgument='<%#Eval("BranchId")%>' OnClientClick="return confirm('Are you sure you want to delete this Branch?');"></asp:LinkButton>--%>
                                    </ItemTemplate>
                                </asp:TemplateField>
                              </Columns>
                          </asp:GridView>
