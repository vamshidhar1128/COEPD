<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="ResumeApproved.aspx.cs" Inherits="Admin_ResumeApproved" %>
                    ...
                    <div class="form-horizontal no-margin">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-4 col-sm-8">
                               ...
                               <asp:Button ID="btnBackToList" runat="server" SkinID="delete" CssClass="btn btn-warning btn-md" Text="Back To List" OnClick="btnBackToList_Click" UseSubmitBehavior="false" />
                            </div>
                        </div>
                    </div>
                </div>
