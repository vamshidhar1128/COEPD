<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="BranchEmployeeNewsSearch.aspx.cs" Inherits="Admin_BranchEmployeeNewsSearch" %>
                ...
                <div class="widget-body">
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-2">
                          ...
                          <div class="col-lg-2 col-md-2">
                            <asp:TextBox runat="server" ID="txtNewsDescription" MaxLength="500" placeholder="Search By News Description" OnTextChanged="txtNewsDescription_TextChanged" AutoPostBack="true"></asp:TextBox>
                        </div>
                        <div class="col-lg-2 col-md-2">
                        ...
                        <div class="col-lg-2  col-md-2">
                            <asp:Button ID="Add" runat="server"  SkinID="addnew" AutoPostBack="True" CausesValidation="false" OnClick="Add_Click"/>
                        </div>
                    </div>
                    <div class="row">
                        &nbsp;
                      ...
                      <div class="row"> 
                          <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false" PageSize="20" HeaderStyle-HorizontalAlign="Center" Width="100%" AllowPaging="true" AllowSorting="true" OnRowCommand="gv_RowCommand" OnPageIndexChanging="gv_PageIndexChanging" ShowHeaderWhenEmpty="true" EmptyDataText="No Records Found!" OnPreRender="gv_PreRender">
                              <Columns>                                  
                                  ...
                                  <asp:BoundField HeaderText="News Description" DataField="NewsDescription" />
                                   ...
                                   <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="150px">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEdit" runat="server" SkinID="edit" CommandName="cmdEdit"
                                            CommandArgument='<%#Eval("BranchEmployeeNewsId")%>'> </asp:LinkButton>
                                        <%--<asp:LinkButton ID="lnkDelete" runat="server" SkinID="delete" CommandName="cmdDelete"
                                            CommandArgument='<%#Eval("BranchEmployeeNewsId")%>' OnClientClick="return confirm('Are you sure you want to delete this Branch Employee News?');"></asp:LinkButton>--%>
                                    </ItemTemplate>
                                </asp:TemplateField>
                              </Columns>
                          </asp:GridView>
