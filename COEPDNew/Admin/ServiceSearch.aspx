<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="ServiceSearch.aspx.cs" Inherits="Admin_ServiceSearch" %>
                ...
                <div class="widget-body">
                    <div class="Row">
                        <div class="col-lg-2 col-md-2">
                            <asp:TextBox runat="server" ID="txtSearchByService" Placeholder="Search by Service" OnTextChanged="txtSearchByService_TextChanged" AutoPostBack="true"></asp:TextBox>
                        </div>
                        <div class="col-lg-2 col-md-2">
                            <asp:TextBox runat="server" ID="txtCreatedByName" Placeholder=" Created By Name"  AutoPostBack="true"></asp:TextBox>
                        </div>
                        <div class="col-lg-2 col-md-2">
                           <asp:TextBox runat="server" ID="txtModifiedByName" Placeholder=" Modified By Name"  AutoPostBack="true"></asp:TextBox>
                        </div>
                        <div class="col-lg-2 col-md-2">
                    ...
                    <div class="Row">
                        <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false" PageSize="20" HeaderStyle-HorizontalAlign="Center" Width="100%" AllowPaging="true" OnRowCommand="gv_RowCommand" AllowSorting="true" OnPageIndexChanging="gv_PageIndexChanging" ShowHeaderWhenEmpty="true" EmptyDataText="No Records Found!" OnPreRender="gv_PreRender">
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Fee" DataField="Fees" />
                            ...
                            <asp:LinkButton ID="lnkEdit" runat="server" SkinID="edit" CommandName="cmdEdit"
                                CommandArgument='<%#Eval("ServiceId")%>'></asp:LinkButton>
