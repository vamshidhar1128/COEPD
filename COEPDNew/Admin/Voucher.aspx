                ...
                <div class="widget-body">
                    <div class="form-horizontal no-margin">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <asp:DropDownList ID="ddlVoucherType" runat="server" required>
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <asp:TextBox ID="txtVoucher" runat="server"  required=""></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">
                            ...
                            <div class="col-sm-10">
                                <asp:DropDownList ID="ddlVendor" runat="server" required="">
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div id="divCheque" style="display: none">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <asp:TextBox ID="txtChequeNo" Type="number" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <asp:TextBox ID="txtAccountNo" Type="number" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <asp:TextBox ID="txtBranch"  runat="server"></asp:TextBox></div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">
