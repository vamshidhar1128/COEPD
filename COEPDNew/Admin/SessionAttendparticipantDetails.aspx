<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="SessionAttendparticipantDetails.aspx.cs" Inherits="Admin_SessionAttendparticipantDetails" %>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="widget">
                    <div class="widget-header">
                        <div class="title">
                            <asp:Label ID="lblTitle" runat="server">Session Attendence</asp:Label>
                        </div>
                    </div>
                    ...
                    <div class="widget-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-lg-3">
                                <asp:TextBox runat="server" ID="txtkeywords" placeholder="Search by ZoomId,Password" AutoPostBack="true" OnTextChanged="txtkeywords_TextChanged"></asp:TextBox>
                            </div>
                            <div class="col-md-2 col-lg-2">
                                <asp:TextBox runat="server" ID="txtCreatedby" placeholder="Search by CreatedBy" AutoPostBack="true" OnTextChanged="txtCreatedby_TextChanged"></asp:TextBox>
                            </div>
                        </div>
                        <div class="row">
                            &nbsp;
                        ...
                        <div class="row">
                            <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false" PageSize="100" HeaderStyle-HorizontalAlign="Center" Width="100%" AllowPaging="true" AllowSorting="true" OnRowDataBound="gv_RowDataBound" OnRowCommand="gv_RowCommand" OnPageIndexChanging="gv_PageIndexChanging" ShowHeaderWhenEmpty="true" EmptyDataText="No Records Found!">
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="CreatedBy Name" DataField="Fullname" />
                                    <asp:TemplateField HeaderText="Students Attended Count" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="150px">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="150px">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkEdit" runat="server" SkinID="View" CommandName="cmdEdit" Text="View"
