...
using BusinessLayer;
public partial class Admin_ActivitySubCategorySearch : System.Web.UI.Page
{
    int Total = 0;
    DateTime DateTime;
    ...
    protected void BindData()
    {
        ...
        //obj.Employee = txtModifiedBy.Text;
        //obj.Description = txtDescription.Text;
        List<clsActivitySubCategory> items = obj.LoadAll(obj);
        if (items != null)
            Total = items.Count;
    ...
    protected void gv_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("ActivitySubCategory.aspx?ItemId=" + e.CommandArgument);
        }
        else if (e.CommandName == "cmdDelete")
        {
            int ItemId = Convert.ToInt16(e.CommandArgument);
            clsActivitySubCategory Item = new clsActivitySubCategory();
            Item.Remove(ItemId);
            BindData();
            ErrorMessage.Text = "Activity Subcategory successfully removed.";
            ErrorMessage.Visible = true;
        }
    }
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        Response.Redirect("ActivitySubCategory.aspx");
    }
