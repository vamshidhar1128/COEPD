<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="BranchHolidaysSearch.aspx.cs" Inherits="Admin_BranchHolidaysSearch" %>
                ...
                <div class="widget-body">
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-2">
                          ...
                          <div class="col-lg-2 col-md-2">
                            <asp:TextBox runat="server" ID="txtPageTitle" MaxLength="500" placeholder="Page Title" OnTextChanged="txtPageTitle_TextChanged" AutoPostBack="true"></asp:TextBox>
                        </div>
                        <div class="col-lg-2 col-md-2">
                      ...
                      <div class="row"> 
                          <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false" PageSize="20" HeaderStyle-HorizontalAlign="Center" Width="100%" AllowPaging="true" AllowSorting="true" OnRowCommand="gv_RowCommand" OnPageIndexChanging="gv_PageIndexChanging" ShowHeaderWhenEmpty="true" EmptyDataText="No Records Found!" OnPreRender="gv_PreRender">
                              <Columns>
                                  ...
                                  <asp:BoundField HeaderText="Page Title" DataField="BranchHolidaysTitle" />
                                   ...
                                   <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="150px">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEdit" runat="server" SkinID="edit" CommandName="cmdEdit"
                                            CommandArgument='<%#Eval("BranchHolidaysId")%>'> </asp:LinkButton>
                                        <%--<asp:LinkButton ID="lnkDelete" runat="server" SkinID="delete" CommandName="cmdDelete"
                                            CommandArgument='<%#Eval("BranchHolidaysId")%>' OnClientClick="return confirm('Are you sure you want to delete this Branch Holidays?');"></asp:LinkButton>--%>
                                    </ItemTemplate>
                                </asp:TemplateField>
                              </Columns>
                          </asp:GridView>
