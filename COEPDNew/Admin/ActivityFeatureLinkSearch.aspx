<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="ActivityFeatureLinkSearch.aspx.cs" Inherits="Admin_ActivityFeatureLinkSearch" %>
                        ...
                        <div class="widget-body">
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-3">
                                    <asp:TextBox runat="server" ID="txtSearch" MaxLength="500" placeholder="Activity Feature Link Status" OnTextChanged="txtSearch_TextChanged" AutoPostBack="true"></asp:TextBox>
                                </div>
                            ...
                            <div class="row">
                                <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false" PageSize="20" HeaderStyle-HorizontalAlign="Center" Width="100%" AllowPaging="true" AllowSorting="true" OnRowCommand="gv_RowCommand" OnPageIndexChanging="gv_PageIndexChanging" ShowHeaderWhenEmpty="true" EmptyDataText="No Records Found!" OnPreRender="gv_PreRender">
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="ActivityAddress Name" DataField="ActivityFeatureName" />
                                        <asp:BoundField HeaderText="ActivityLink Address" DataField="ActivityAddressName" />           
                                        <asp:BoundField HeaderText="ActivityTaskId" DataField="ActivityId" />           
                                        ...
                                        <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="150px">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkEdit" runat="server" SkinID="edit" CommandName="cmdEdit"
                                                    CommandArgument='<%#Eval("ActivityFeatureLinkId")%>'></asp:LinkButton>
