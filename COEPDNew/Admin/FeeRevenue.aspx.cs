...
public partial class Admin_FeeRevenue : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        ...
        gv.DataSource = obj.FeeRevenue(obj);
        gv.DataBind();
    }
    ...
    protected void btnDownload_Click(object sender, EventArgs e)
    {
        ...
        ExportToExcel(FileNamePrepix + "-FeeRevenue.xls", gv);
    }
