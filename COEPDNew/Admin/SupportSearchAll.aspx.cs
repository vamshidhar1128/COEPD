...
using BusinessLayer;
public partial class Admin_SupportSearchAll : System.Web.UI.Page
{
   ...
   // public int GlobalSupportType;
    ...
    protected void BindData()
    {
        ...
        obj.EmployeeId = 0;
        List<clsSupport> objList = obj.LoadAllList(obj);
        if (objList != null)
        {
    ...
    protected void ddlStatus_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        //    if(gv.PageIndex==0)
        //    {
        //        gv.Rows[0].FindControl("lnkEdit").Visible = true;
        //        gv.Rows[0].FindControl("lnkDelete").Visible = true;
        //    }
        //}
