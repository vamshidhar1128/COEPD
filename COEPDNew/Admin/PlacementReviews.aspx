<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="PlacementReviews.aspx.cs" Inherits="Admin_PlacementReviews" %>
                    ...
                    <div class="form-horizontal no-margin">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">
                                BA Job market  Reviews Name
                            </label>
                            <div class="col-sm-10">
                                <asp:TextBox ID="txtPlacementReviewsName"  MaxLength="500" runat="server" Required=""></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">
