<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="ActivitySubCategorySearch.aspx.cs" Inherits="Admin_ActivitySubCategorySearch" EnableEventValidation="false"%>
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-3">
                                    <asp:TextBox runat="server" ID="txtActivitySubCategory" MaxLength="500" placeholder="Search By Activity Sub Category" OnTextChanged="txtActivityCategory_TextChanged" AutoPostBack="true"></asp:TextBox>
                                </div>
                                ...
                                <div class="Col-lg-2 col-md-2">
                                    <asp:TextBox runat="server" ID="textModified" MaxLength="500" placeholder="Search By Modified By" OnTextChanged="txtActivityCategory_TextChanged" AutoPostBack="true"></asp:TextBox>
                                </div>
                                <%-- <div class="col-lg-3 col-md-3">
                                        ...
                                        <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="150px">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkEdit" runat="server" SkinID="edit" CommandName="cmdEdit"
                                                    CommandArgument='<%#Eval("ActivitySubCategoryId")%>'></asp:LinkButton>
                                                <asp:LinkButton ID="lnkDelete" runat="server" SkinID="delete" CommandName="cmdDelete"
                                                    CommandArgument='<%#Eval("ActivitySubCategoryId")%>' OnClientClick="return confirm('Are you sure you want to delete this ActivityCategory?');"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
