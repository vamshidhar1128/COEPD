...
public partial class Admin_InternBatchsearch : System.Web.UI.Page
{
    ...
    protected void gv_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("InternBatch.aspx?ItemId=" + e.CommandArgument);
        }
        else if (e.CommandName == "cmdDelete")
        {
            ...
            Item.Remove(ItemId);
            BindData();
            ErrorMessage.Text = "Intern Batch successfully removed";
