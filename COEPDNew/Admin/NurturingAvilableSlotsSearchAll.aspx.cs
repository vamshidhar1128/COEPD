...
public partial class Admin_NurturingAvilableSlotsSearchAll : System.Web.UI.Page
{
    ...
    protected void BindSlotStatus()
    {
        ...
        ddlSlotStatus.DataTextField = "SlotStatus";
        ddlSlotStatus.DataValueField = "SlotsStatusId";
        ddlSlotStatus.DataBind();
        ddlSlotStatus.Items.Insert(0, new ListItem("Search by SlotStatus", "0"));
    }
