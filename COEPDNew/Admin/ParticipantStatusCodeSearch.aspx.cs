...
public partial class Admin_ParticipantStatusCodeSearch : System.Web.UI.Page
{
    int Total = 0;
    ...
    protected void BindData()
    {
        ...
        if (txtModifiedby.Text != "")
            obj.Modifiedname = txtModifiedby.Text;
        List<clsParticipantStatusCode> items = obj.LoadAll(obj);
        if (items != null)
        {
            Total = items.Count;
        }
    ...
    protected void gv_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("ParticipantStatusCode.aspx?ItemId=" + e.CommandArgument);
        }
        ...
        //    ErrorMessage.Text = "Status successfully removed";
    ...
    {
        Response.Redirect("participantStatusCode.aspx");
    }
    ...
    protected void txtModifiedby_TextChanged(object sender, EventArgs e)
    {
        BindData();
    }
}