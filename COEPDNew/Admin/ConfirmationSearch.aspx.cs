...
public partial class Admin_ConfirmationSearch : System.Web.UI.Page
{
    int Total = 0;
    DateTime DateTime;
    ...
    protected void BindData()
    {
        ...
        if(obj.IsConfirmation==null)
        {
            obj.IsConfirmation = null;
        }
        List<clsLeadReceipt> items = obj.LoadAll(obj);
        if (items != null)
            Total = items.Count;
    ...
    protected void gv_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("Confirmation.aspx?ItemId=" + e.CommandArgument);
        }
