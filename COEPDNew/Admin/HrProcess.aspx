<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="HrProcess.aspx.cs" Inherits="Admin_HrProcess" %>
                ...
                <div class="widget-body">
                    <div class="form-horizontal no-margin">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <asp:DropDownList ID="ddlParticipant" runat="server" OnSelectedIndexChanged="ddlParticipant_SelectedIndexChanged" AutoPostBack="true">
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">
                                Select Stage
                                <asp:HiddenField ID="hdnHrProcessSlotsId" Value="0" runat="server" />
                            </label>
                            <div class="col-sm-6">
                                <asp:DropDownList ID="ddlHrProcessStage" runat="server"  AutoPostBack="true" OnSelectedIndexChanged="ddlHrProcessStage_SelectedIndexChanged">
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <asp:DropDownList ID="ddlHrProcessStageTask" runat="server" required="" AutoPostBack="true" OnSelectedIndexChanged="ddlHrProcessStageTask_SelectedIndexChanged">
                                </asp:DropDownList>
                            </div>
                        </div>
            ...
            <div class="widget">
                ...
                <div class="widget-body" style="height: 300px; overflow-y: scroll">
                    <div class="viewport">
                        <div class="overview">
                            <ul class="chats">
                                <asp:Repeater ID="rpHrTeamInputs" runat="server" OnItemDataBound="rpHrTeamInputs_ItemDataBound">
                                    <ItemTemplate>
                                        <asp:HiddenField ID="hdnHrTeamInputsRoleId" runat="server" Value='<%# Eval("RoleId")%>' />
                                        <asp:Panel ID="pnlIn" runat="server" Visible="false">
                                            <li class="in">
                                                <img class="avatar" alt="" src="../img/profile.png" />
                                                <span class="name">Task Name:
                                                        <%# Eval("HrProcessStageTaskName") %>
                                                </span>
                                                <div class="message">
                                                    <span class="arrow"></span><a href="#" class="name">
                                                        <%# Eval("Participant")%>
