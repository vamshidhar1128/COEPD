...
public partial class Admin_ParticipantFeeLost : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        ...
        if (txtFromDate.Text != "")
        {
            obj.FromDate = Convert.ToDateTime(DateTime.Now.AddDays(-180));
        }
        else
        {
            obj.FromDate = null;
        ...
        if (txtToDate.Text != "")
        {
            obj.ToDate = Convert.ToDateTime(DateTime.Now.AddDays(-46));
        }
        else
        {
            obj.ToDate = null;
        ...
        gv.DataSource = obj.ParticipantFeeLost(obj);
        gv.DataBind();
    }
    ...
    protected void btnDownload_Click(object sender, EventArgs e)
    {
        ...
        ExportToExcel(FileNamePrepix + "-Participant FeeLost.xls", gv);
    }
