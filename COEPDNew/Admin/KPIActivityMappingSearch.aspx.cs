...
public partial class Admin_KPIActivityMappingSearch : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("KPIActivityMapping.aspx");
    }
    ...
    protected void gv_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("KPIActivityMapping.aspx?ItemId=" + e.CommandArgument);
        }
        else if (e.CommandName == "cmdDelete")
        {
            int ItemId = Convert.ToInt32(e.CommandArgument);
            clsKPIActivityMapping Item = new clsKPIActivityMapping();
            Item.Remove(ItemId);
            BindData();
            ErrorMessage.Text = "KPI activity mapping successfully removed.";
