<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="PlacementReviewsSearch.aspx.cs" Inherits="Admin_PlacementReviewsSearch" %>
                                ...
                                <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="150px">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEdit" runat="server" SkinID="edit" CommandName="cmdEdit"
                                            CommandArgument='<%#Eval("PlacementReviewsId")%>'></asp:LinkButton>
                                        <asp:LinkButton ID="lnkDelete" runat="server" SkinID="delete" CommandName="cmdDelete"
                                            CommandArgument='<%#Eval("PlacementReviewsId")%>' OnClientClick="return confirm('Are you sure you want to delete this Placement Review?');"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField HeaderText="SNo" DataField="SNo" ItemStyle-Width="50px" />
                                <asp:BoundField HeaderText="Placement Review Name" DataField="PlacementReviewsName" />
                                ...
                                <asp:TemplateField HeaderText="Image">
                                    <ItemTemplate>
                                        <a href='../UserDocs/PlacementReviews/<%#Eval("ImagePath")%>' target="_blank">
                                            <img src='../UserDocs/PlacementReviews/<%#Eval("ImagePath")%>' alt='Placement Reviews' width="50px" height="50px" />
                                        </a>
                                    </ItemTemplate>
