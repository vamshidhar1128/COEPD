<%@ Page Title="" Language="C#" MasterPageFile="Admin.master" AutoEventWireup="true"
    CodeFile="NewsScrollSearch.aspx.cs" Inherits="NewsScrollSearch" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-md-9">
                            <asp:DropDownList ID="ddlNews" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlNews_SelectedIndexChanged">
                                ...
                                <asp:ListItem Text="Scrolling News in all pages " Value="0"></asp:ListItem>
                                ...
                                <asp:ListItem Text="Webdeign internship" Value="14"></asp:ListItem>
                                <asp:ListItem Text="Dotnet internship" Value="15"></asp:ListItem>
                                <asp:ListItem Text="Datascience internship" Value="16"></asp:ListItem>
                                <asp:ListItem Text="Digital marketing internship" Value="17"></asp:ListItem>
                                <asp:ListItem Text="Scrolling News in all Participant Pages" Value="18"></asp:ListItem>
                                <asp:ListItem Text="Scrolling News in IIBA CPOA Certification Training" Value="19"></asp:ListItem>
                                <%-- <asp:ListItem Text="BA internship" Value="18"></asp:ListItem>--%>
                            </asp:DropDownList>
                        </div>
                                    ...
                                    <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="150px">
                                        <ItemTemplate>
                                            ...
                                            <asp:LinkButton ID="lnkDelete" runat="server" SkinID="delete" CommandName="cmdDelete"
                                                CommandArgument='<%#Eval("NewsId")%>' OnClientClick="return confirm('Are you sure you want to delete this Scroll news?');"></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
