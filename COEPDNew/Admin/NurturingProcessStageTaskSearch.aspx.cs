...
public partial class Admin_NurturingProcessStageTaskSearch : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        ...
        if (txtNurturingProcessStageTaskName.Text != "")
            obj.NurturingProcessStageTaskName = txtNurturingProcessStageTaskName.Text;
    ...
    protected void gv_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("NurturingProcessStageTask.aspx?ItemId=" + e.CommandArgument);
        }
        else if (e.CommandName == "cmdDelete")
        {
            ...
            Item.Remove(ItemId);
            BindData();
            ErrorMessage.Text = "Nurturing Process Stage Task successfully removed";
    ...
    {
        Response.Redirect("NurturingProcessStageTask.aspx");
    }
}