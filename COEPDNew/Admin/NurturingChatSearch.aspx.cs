...
public partial class Admin_NurturingChatSearch : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        ...
        if (txtNurturingProcessStageTask.Text != "")
            Item.NurturingProcessStageTaskName = txtNurturingProcessStageTask.Text;
    ...
    protected void gv_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("NurturingChat.aspx?ItemId=" + e.CommandArgument);
        }
