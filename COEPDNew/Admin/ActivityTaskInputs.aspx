<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="ActivityTaskInputs.aspx.cs" Inherits="Admin_ActivityTaskInputs" %>
                            ...
                            <div class="form-horizontal no-margin">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2 control-label">
                                        <asp:Label ID="lblActivityCategory" runat="server"></asp:Label>
                                    </div>
                                    <label class="col-sm-1 control-label">
                                        Activity SubCategory:
                                    </label>
                                    <div class="col-sm-2 control-label">
                                        <asp:Label ID="lblActivitySubcategory" runat="server"></asp:Label>
                                    </div>
                                    <label class="col-sm-1 control-label">
                                        Activity:
                                    </label>
                                    <div class="col-sm-2 control-label">
                                        ...
                                        <asp:HiddenField runat="server" ID="hdnActivityId" />
                                    </div>
                                    <label class="col-sm-1 control-label">
                                        Task Title:
                                    </label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2 control-label">
                                        <asp:Label ID="lblInvolvedLeads" runat="server"></asp:Label>
                                    </div>
                                    <label class="col-sm-1 control-label">
                                        Involved Vendors:
                                    </label>
                                    <div class="col-sm-2 control-label">
                                        <asp:Label ID="lblInvolvedVendors" runat="server"></asp:Label>
                                    </div>
                                </div>
                                <br />
                                <div class="form-group">
                                    <div class="col-sm-offset-4 col-sm-10">
                                        <asp:Button ID="btnStartActivity" runat="server" Autopostback="true" Text="Start Task" OnClick="btnStartActivity_Click"></asp:Button>
                                    </div>
                                </div>
                                <br />
                                <div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-2 col-md-2">
                                                <asp:TextBox ID="txtsHours" runat="server" type="number" Required="" OnTextChanged="txtsHours_TextChanged" Placeholder="HH"
                                                    Width="70px" min="0" max="23"></asp:TextBox>
                                            </div>
                                            <div class="col-lg-2 col-md-2">
            ...
            <%--                                    <asp:DropDownList ID="ddlEStartAMPM" runat="server">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row">
                                            <div class="col-lg-2 col-md-2">
                                                <asp:TextBox ID="txtEHours" runat="server" type="number" OnTextChanged="txtEHours_TextChanged" Placeholder="HH" Width="70px"
                                                    min="0" max="23"></asp:TextBox>
                                            </div>
                                            <div class="col-lg-2 col-md-2">
                                                <asp:TextBox ID="txtEmints" runat="server" type="number" OnTextChanged="txtEmints_TextChanged" Placeholder="MM" Width="70px"
