...
using BusinessLayer;
public partial class Admin_HrShortlistResume : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("HrAvilableResumes.aspx");
    }
    protected void btnSend_Click(object sender, EventArgs e)
    {
        ...
        if (txtChat.Text.Length > 0)
        {
            ...
            Response.Redirect("HrShortlistResume.aspx?ItemId=" + ItemId);
        }
    }
    ...
    protected void btnShortlist_Click(object sender, EventArgs e)
    {
        ...
        obj.HrStatus = true;
        obj.HrNotShortlist = false;
       // obj.EmployeeId = CurrentUser.CurrentEmployeeId;
        obj.AddUpdate(obj);
        Response.Write("<script>alert('Resume Shortlisted Successfully')</script>");
