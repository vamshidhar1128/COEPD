<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="ConfirmationReceiptSearch.aspx.cs" Inherits="Admin_ConfirmationReceiptSearch" EnableEventValidation="false" %>
                        ...
                        <div class="widget-body">
                            <div class="row">
                                <div class="col-lg-3 col-md-3">
                                    <asp:TextBox runat="server" ID="txtActivityCategory"  MaxLength="500" Visible="false" OnTextChanged="txtActivityCategory_TextChanged"></asp:TextBox>
                                </div>
                                <div class="col-lg-3 col-md-3">
                                    <asp:TextBox runat="server" ID="txtFullname" MaxLength="500" Visible="false" OnTextChanged="txtActivityCategory_TextChanged"></asp:TextBox>
                                </div>
                                <div class="col-lg-3 col-md-3">
                                    <asp:TextBox runat="server" ID="textModified" MaxLength="500" Visible="false" OnTextChanged="txtActivityCategory_TextChanged"  ></asp:TextBox>
                                </div>
                            ...
                            <div class="row">
                                <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false" PageSize="20" Width="100%" AllowPaging="true" AllowSorting="true" OnPageIndexChanging="gv_PageIndexChanging" OnRowCommand="gv_RowCommand" ShowHeaderWhenEmpty="true" EmptyDataText="No Records Found!" OnPreRender="gv_PreRender">
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="Lead Name" DataField="LeadName" />
                                        <asp:BoundField HeaderText="Batch Date" DataField="StartDate" DataFormatString="{0: dd MMM yyyy}" />
                                        <asp:BoundField HeaderText="Location" DataField="Location" />
                                        <asp:BoundField HeaderText="Service Owner Name" DataField="ServicesName" />
                                        ...
                                        <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="150px">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkEdit" runat="server" SkinID="Orange" Text="Generate Receipt" CommandName="cmdEdit"
