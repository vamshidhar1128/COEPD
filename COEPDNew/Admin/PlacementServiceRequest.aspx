<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="PlacementServiceRequest.aspx.cs" Inherits="Admin_PlacementServiceRequest" %>
                ...
                <div class="form-horizontal no-margin">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-9">
                            <asp:Button ID="btnSend" runat="server" SkinID="btnBack" Text="Send Resolution" UseSubmitBehavior="false"
                                OnClick="btnSend_Click" />
                            <asp:Button ID="btnBack" runat="server" Text="Back To List" SkinID="btnWarning" UseSubmitBehavior="false"
