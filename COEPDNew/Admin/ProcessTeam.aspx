<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="ProcessTeam.aspx.cs" Inherits="Admin_ProcessTeam" %>
                ...
                <div class="widget-body">
                    ...
                    <div class="row">
                        <div class="table-responsive">
                            <asp:GridView ID="Gv3" runat="server" AutoGenerateColumns="False" Width="100%">
                                <Columns>
                                    <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="100px" Visible="false">
                                        <ItemTemplate>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField HeaderText="Team Head" DataField="Roles" ItemStyle-Width="140px" />
                        ...
                        <div class="table-responsive">
                            <asp:GridView ID="Gv2" runat="server" AutoGenerateColumns="False" Width="100%">
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Team" DataField="Roles" ItemStyle-Width="140px" />
                                    <asp:BoundField HeaderText="Reporting Manager" DataField="Employee" />
                                </Columns>
                        ...
                        <div class="table-responsive">
                            <asp:GridView ID="gv" runat="server" AutoGenerateColumns="False" Width="100%">
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="CUG Number" DataField="CUGMobile" />
                                </Columns>
                                <EmptyDataTemplate>
                                    <center>
                                        No Records Found
