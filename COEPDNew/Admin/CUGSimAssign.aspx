<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="CUGSimAssign.aspx.cs" Inherits="Admin_CUGSimAssign" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        function alertmeSave() {
            Swal.fire(
                'Sim Number Assign Successfully',
                '',
                'success'
            )
        }
        function alertmeUpdate() {
            Swal.fire(
                'Sim Number Updated Successfully',
                '',
                'success'
            )
        }
                    ...
                    <div class="form-horizontal no-margin">
                        <div class="row">
                            <div class="col-lg-3 col-md-3">
                                <asp:TextBox ID="txtCUGSimMobile" runat="server" AutoPostBack="True" Placeholder="Search by Mobile" OnTextChanged="txtCUGSimMobile_TextChanged"></asp:TextBox>
                            </div>
                            <div class="col-lg-1 col-md-1">
                                <h5>Mobile</h5>
                            </div>
                            <div class="col-lg-2 col-md-2">
                                <asp:DropDownList ID="ddlMobile" runat="server" Required="">
                                </asp:DropDownList>
                            </div>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">
                                            Sim Used For :<sup class="sup">*</sup>
                                        </label>
                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txtSimUsedFor" runat="server" required=""></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">
                                            Aadhar Number :<sup class="sup">*</sup>
                                        </label>
                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txtAadharNumber" runat="server" required=""></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">
