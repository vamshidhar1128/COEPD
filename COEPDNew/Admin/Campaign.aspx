<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="Campaign.aspx.cs" Inherits="Admin_Campaign" %>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <asp:TextBox ID="txtStartDay" min="1" Max="31" runat="server" type="number" CssClass="form-control"
                                    placeholder="DD" Required=""></asp:TextBox>
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-2">
                                <asp:TextBox ID="txtStartYear" runat="server" type="number" CssClass="form-control" placeholder="YYYY"
                                    Required="" MaxLength="4" min="1950"></asp:TextBox>
                            </div>
                                </div>
                            </div>
                        </div>
