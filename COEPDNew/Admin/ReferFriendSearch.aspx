<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="ReferFriendSearch.aspx.cs" Inherits="Admin_ReferFriendSearch" %>
                    ...
                    <div class="row">
                        <div class="table-responsive">
                            <asp:GridView ID="gv" runat="server" AutoGenerateColumns="False"
                                Width="100%" PageSize="50" HeaderStyle-HorizontalAlign="Center" AllowPaging="true" AllowSorting="true" EmptyDataText="No Records Found!" ShowHeaderWhenEmpty="true" OnPreRender="gv_PreRender" OnRowDataBound="gv_RowDataBound" OnPageIndexChanging="gv_PageIndexChanging">
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Created By" DataField="Employee" ItemStyle-Width="150px" />
