<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="HrProcessStageSearch.aspx.cs" Inherits="Admin_HrProcessStageSearch" %>
                        ...
                        <div class="widget-body">
                            <div class="Row">
                                <div class="col-lg-2 col-md-2">
                                    <asp:TextBox runat="server" ID="txtNurturingProcessStageName" MaxLength="250" Placeholder="HrProcessStage Name" OnTextChanged="txtNurturingProcessStageName_TextChanged" AutoPostBack="True"></asp:TextBox>
                                </div>
                                <div class="col-lg-2 col-md-2">
                            ...
                            <div class="Row">
                                <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false" PageSize="20" HeaderStyle-HorizontalAlign="Center" Width="100%" AllowPaging="true" OnRowCommand="gv_RowCommand" AllowSorting="true" OnPageIndexChanging="gv_PageIndexChanging" ShowHeaderWhenEmpty="true" EmptyDataText="No Records Found!" OnPreRender="gv_PreRender">
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="Hr Process Stage Name" DataField="HrProcessStageName" />
                                        ...
                                        <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="150px">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkEdit" runat="server" SkinID="edit" CommandName="cmdEdit"
                                                    CommandArgument='<%#Eval("HrProcessStageId")%>'></asp:LinkButton>
                                                <asp:LinkButton ID="lnkDelete" runat="server" SkinID="delete" CommandName="cmdDelete"
                                            CommandArgument='<%#Eval("HrProcessStageId")%>' OnClientClick="return confirm('Are you sure you want to delete this Hr Process Stage?');"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
