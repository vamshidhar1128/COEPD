...
using BusinessLayer;
public partial class Admin_BranchHolidaysSearch : System.Web.UI.Page
{
    ...
    {
        clsBranchHolidays obj = new clsBranchHolidays();
        if (txtPageTitle.Text != "")
            obj.BranchHolidaysTitle = txtPageTitle.Text;
        if (txtLocation.Text != "")
    ...
    {
        Response.Redirect("BranchHolidays.aspx");
    }
    protected void gv_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "cmdEdit")
        {
            ...
            Response.Redirect("BranchHolidays.aspx?ItemId=" + e.CommandArgument);
        }
        else if (e.CommandName == "cmdDelete")
        {
            int ItemId = Convert.ToInt16(e.CommandArgument);
            clsBranchHolidays Item = new clsBranchHolidays();
            Item.Remove(ItemId);
            BindData();
            ErrorMessage.Text = "Branch Holidays successfully removed";
