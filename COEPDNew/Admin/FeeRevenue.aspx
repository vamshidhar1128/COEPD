<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="FeeRevenue.aspx.cs" Inherits="Admin_FeeRevenue" EnableEventValidation="false" %>
                ...
                <div class="widget-body">
                    <div class="row">
                        <div class="col-lg-2 col-md-2">
                            <asp:TextBox runat="server" ID="txtLead" placeholder="Search By Lead"></asp:TextBox>
                        </div>
                        <div class="col-lg-2 col-md-2">
                        ...
                        <div class="col-lg-2 col-md-2">
                            <asp:TextBox runat="server" ID="txtinstallments" placeholder="Search By Installments"></asp:TextBox>
                        </div>
                    ...
                    <div class="row">
                        <div class="table-responsive">
                            <asp:GridView ID="gv" runat="server" AutoGenerateColumns="False" Width="100%" PageSize="100" HeaderStyle-HorizontalAlign="Center" ShowFooter="true" AllowPaging="true" AllowSorting="true" ShowHeaderWhenEmpty="true" EmptyDataText="No Records Found!" OnPreRender="gv_PreRender" OnRowCommand="gv_RowCommand" OnRowDataBound="gv_RowDataBound">
                                <Columns>
                                   ...
                                   <asp:BoundField HeaderText="Agreed Amount " DataField="AgreedFee" />
                                    ...
                                    <asp:TemplateField HeaderText="Paying Amount">
                                        <ItemTemplate>
                                    ...
                                    <%--<asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="50px">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkEdit" runat="server" Text="Status" SkinID="view" CommandName="cmdEdit"
