<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="ReportingManagerMappingSearch.aspx.cs" Inherits="Admin_ReportingManagerMappingSearch" %>
      ...
      <div class="col-lg-12 col-md-12">
          <div class="widget">
              <div class="widget-header">
                  <div class="title">
                      Employee Mapping ( Assigning ReportingManager to VerticalHead)
                  </div>
              </div>
                                      ...
                                      <asp:TemplateField HeaderText="Add to Location" ItemStyle-HorizontalAlign="Center"
                                          ...
                                          <ItemTemplate>
                                              <asp:LinkButton ID="lnkSend" runat="server" Text="Remove Employee >>" CommandName="cmdRemove"
                                                  CssClass="btn btn-danger" CommandArgument='<%#Eval("ReportingEmployeeMappedId")%>'></asp:LinkButton>
                                          </ItemTemplate>
                                      </asp:TemplateField>
                                  </Columns>
                                  <EmptyDataTemplate>
