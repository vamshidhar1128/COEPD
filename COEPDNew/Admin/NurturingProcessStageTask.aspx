<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="NurturingProcessStageTask.aspx.cs" Inherits="Admin_NurturingProcessStageTask" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <script type="text/javascript">
        function alertmeSave() {
            Swal.fire(
                      'Nurturing Process Stage Task Added Successfully',
                      '',
                      'success'
                    )
        }
        function alertmeUpdate() {
            Swal.fire(
                      'Nurturing Process Stage Task Updated Successfully',
                      '',
                      'success'
                    )
        }
        ...
        function alertmeDuplicate() {
            Swal.fire(
                      'Nurturing Process Stage Task already exist',
                      '',
                      'warning'
                    )
        }
                        ...
                        <div class="widget-body">
                            <div class="form-horizontal no-margin">
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-3 control-label">
                                        Nurturing Process Stage Task Name<sup class="sup">*</sup>:
                                    </label>
                                    <div class="col-sm-5">
