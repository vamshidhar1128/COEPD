...
public partial class Admin_ParticipantDiscountSearch : System.Web.UI.Page
{
    int Total = 0;
    DateTime DateTime;
    ...
    {
        clsParticipantDiscount obj = new clsParticipantDiscount();
      
       
        gv.DataSource = obj.DiscountLoadAll(obj);
        gv.DataBind();
    }
    ...
    {
       Response.Redirect("ParticipantDiscount.aspx");
    }
    ...
    protected void btnDownload_Click(object sender, EventArgs e)
    {
        ...
        ExportToExcel(FileNamePrepix + "-ParticipantDiscountSearch.xls", gv);
    }
