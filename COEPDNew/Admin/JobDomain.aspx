<%@ Page Title="" Language="C#" MasterPageFile="Admin.master" AutoEventWireup="true"
    CodeFile="JobDomain.aspx.cs" Inherits="JobDomain" %>
                ...
                <div class="widget-body">
                    <div class="form-horizontal no-margin">
                        <div class="form-group">
                            <label for="JobDomain" class="col-md-2">
                                Domain
                            </label>
                            <div class="col-sm-10">
                                <asp:TextBox ID="txtJobDomain" MaxLength="500" runat="server" Required=""></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
