<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="UserExamMaster.aspx.cs" Inherits="Admin_UserExamMaster" %>
                    ...
                    <div class="row">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4">
                                ...
                                <asp:DropDownList ID="ddlCategory" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlCategory_SelectedIndexChanged">
                                    <asp:ListItem Text= "Staff" Value="25"></asp:ListItem>
                                </asp:DropDownList>
                            </div>
