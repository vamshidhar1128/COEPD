...
public partial class Admin_ReportingManagerMappingSearch : System.Web.UI.Page
{
    ...
    protected void gvUser_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        else
        {
            if (e.CommandName == "cmdAdd")
            {
                ...
                Item.ReportingManagerEmployeeId = Convert.ToInt32(e.CommandArgument);
                Item.VerticalHeadEmployeeId = Convert.ToInt32(ddlemployee.SelectedValue);
                Item.IsAssigned = true;
                Item.CreatedBy = CurrentUser.CurrentUserId;
                Item.AddUpdates(Item);
    ...
    protected void BindReportingManager()
    {
        ...
        sqlconn.Open();
        SqlCommand con = new SqlCommand("select * from [dbo].[tblEmployee] where IsVerticalHead =" + 1, sqlconn);
        con.CommandType = CommandType.Text;
        ddlemployee.DataSource = con.ExecuteReader();
        ddlemployee.DataTextField = "Employee";
        ddlemployee.DataValueField = "EmployeeId";
        ddlemployee.DataBind();
        ddlemployee.Items.Insert(0, new ListItem("-- Select VerticalHead --", "0"));
        sqlconn.Close();
    ...
    protected void BindData()
    {
        ...
        gv.DataSource = obj.ReportingLoadAll(obj);
        gv.DataBind();
    }
