<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="HrProcessStage.aspx.cs" Inherits="Admin_HrProcessStage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        function alertmeSave() {
            Swal.fire(
                'Hr Process Stage Added Successfully',
                '',
                'success'
            )
        }
        function alertmeUpdate() {
            Swal.fire(
                'Hr Process Stage Updated Successfully',
                '',
                'success'
            )
        }
        ...
        function alertmeDuplicate() {
            Swal.fire(
                'Hr Process Stage already exist',
                '',
                'warning'
            )
        }
