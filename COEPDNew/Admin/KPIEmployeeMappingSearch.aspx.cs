...
using BusinessLayer;
public partial class Admin_KPIEmployeeMappingSearch : System.Web.UI.Page
{
    ...
    protected void gv_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("KPIEmployeeMapping.aspx?ItemId=" + e.CommandArgument);
        }
        else if (e.CommandName == "cmdDelete")
        {
            int ItemId = Convert.ToInt32(e.CommandArgument);
            clsKPIEmployeeMapping Item = new clsKPIEmployeeMapping();
            Item.Remove(ItemId);
            BindData();
            ErrorMessage.Text = "KPI Employee Mapping successfully removed.";
    ...
    {
        Response.Redirect("KPIEmployeeMapping.aspx");
    }
