<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="KPISearch.aspx.cs" Inherits="Admin_KPISearch" %>
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                <div class="Row">
                                    ...
                                    <div class="col-lg-2 col-md-2">
                                        <asp:TextBox runat="server" ID="txtKPIApplicalbeTo" MaxLength="25" Placeholder="KPI Applicable To" OnTextChanged="txtKPIApplicalbeTo_TextChanged" AutoPostBack="true"></asp:TextBox>
                                    </div>
                                    <div class="col-lg-2 col-md-2">
                                ...
                                <div class="Row">
                                    <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false" PageSize="20" HeaderStyle-HorizontalAlign="Center" Width="100%" AllowPaging="true" OnRowCommand="gv_RowCommand" AllowSorting="true" OnPageIndexChanging="gv_PageIndexChanging" ShowHeaderWhenEmpty="true" EmptyDataText="No Records Found!" OnPreRender="gv_PreRender">
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="KPI Applicable To" DataField="KPIApplicableTo" />
