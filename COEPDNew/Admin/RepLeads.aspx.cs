...
using BusinessLayer;
public partial class Admin_RepLeads : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        if (ddlLocation.Items.Count > 0)
        {
            ...
            obj.LeadStatusId = Convert.ToInt16(1);
            ...
            {
                gv.Caption = " Leads Reports Of " + ddlEmployee.SelectedItem + " From " + txtFromDate.Text + " To " + txtToDate.Text;
                gv.DataSource = obj.LoadAllReport(obj);
                gv.DataBind();
            }
            else
            {
                gv.Caption = "Leads Reports From " + txtFromDate.Text + " To " + txtToDate.Text;
                gv.DataSource = obj.LoadAllReport(obj);
                gv.DataBind();
            }
        }
