<%@ Page Title="" Language="C#" MasterPageFile="Admin.master" AutoEventWireup="true"
    CodeFile="TopicSearch.aspx.cs" Inherits="TopicSearch" %>
                                ...
                                <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="150px">
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton ID="lnkDelete" runat="server" SkinID="delete" CommandName="cmdDelete"
                                            CommandArgument='<%#Eval("TopicId")%>' OnClientClick="return confirm('Are you sure you want to delete this topic?');"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField HeaderText="SNo" DataField="SNo" ItemStyle-Width="50px" />
                                <asp:BoundField HeaderText="Exam Category" DataField="Category" />
                                <asp:BoundField HeaderText="Prep Exam Topic" DataField="Topic" />
                            </Columns>
                            <EmptyDataTemplate>
                                <center>
                                    No Records Found
