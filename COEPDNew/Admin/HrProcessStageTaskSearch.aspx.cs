...
public partial class Admin_HrProcessStageTaskSearch : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        ...
        if (txtNurturingProcessStageTaskName.Text != "")
            obj.HrProcessStageTaskName = txtNurturingProcessStageTaskName.Text;
    ...
    protected void gv_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("HrProcessStageTask.aspx?ItemId=" + e.CommandArgument);
        }
        else if (e.CommandName == "cmdDelete")
        {
            ...
            Item.Remove(ItemId);
            BindData();
            ErrorMessage.Text = "Hr Process Stage Task successfully removed";
    ...
    {
        Response.Redirect("HrProcessStageTask.aspx");
    }
}