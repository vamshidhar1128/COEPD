<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="NurturingChatSearch.aspx.cs" Inherits="Admin_NurturingChatSearch" %>
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2 col-md-2">
                                    <asp:TextBox runat="server" ID="txtNurturingProcessStageTask" MaxLength="500" placeholder="Stage Task" AutoPostBack="true" OnTextChanged="txtNurturingProcessStageTask_TextChanged"></asp:TextBox>
                                </div>
                                ...
                                <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false" PageSize="100" HeaderStyle-HorizontalAlign="Center" Width="100%" AllowPaging="true" AllowSorting="true" OnRowCommand="gv_RowCommand" OnPageIndexChanging="gv_PageIndexChanging" ShowHeaderWhenEmpty="true" EmptyDataText="No Records Found!" OnPreRender="gv_PreRender" OnRowDataBound="gv_RowDataBound">
                                    <Columns>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:HyperLink NavigateUrl='<%#"~/UserDocs/NurturingServiceRequests/"+ Eval("SenderImagePath") %>' runat="server"
                                    ...
                                    <asp:TemplateField HeaderText="View File From Mentor">
                                        <ItemTemplate>
                                            ...
                                            <asp:HyperLink NavigateUrl='<%#"~/UserDocs/NurturingServiceRequests/"+ Eval("ReceiverImagePath") %>' runat="server"
                                        ...
                                        <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="150px">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkEdit" runat="server" SkinID="edit" CommandName="cmdEdit"
                                                    CommandArgument='<%#Eval("NurturingChatId")%>'></asp:LinkButton>
                                                <%--<asp:LinkButton ID="lnkDelete" runat="server" SkinID="delete" CommandName="cmdDelete"
                                            CommandArgument='<%#Eval("NurturingChatId")%>' OnClientClick="return confirm('Are you sure you want to delete this Chat?');"></asp:LinkButton>--%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
