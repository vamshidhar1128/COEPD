...
public partial class Admin_ReferFriendSearchAll : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        if (currentUser.CurrentEmployeeId > 0)
        {
            ...
            if (txtParticipantUPIID.Text != "")
                obj.ParticipantUPIID = txtParticipantUPIID.Text;

            if (txtPlanningToJoinTheCourse.Text != "")
                obj.PlanningToJoinTheCourse = txtPlanningToJoinTheCourse.Text;

            List<clsReferFriend> items = obj.LoadAll(obj);
            if (items != null)
                Total = items.Count;
    ...
    protected void txtParticipantUPIID_TextChanged(object sender, EventArgs e)
    {
        BindData();
    }

    protected void txtPlanningToJoinTheCourse_TextChanged(object sender, EventArgs e)
    {
        BindData();
    }
