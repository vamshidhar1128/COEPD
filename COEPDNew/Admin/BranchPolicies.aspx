<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="BranchPolicies.aspx.cs" Inherits="Admin_BranchPolicies" %>
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-5">
                             ...
                             <div class="form-group">
                            <label class="col-sm-2 control-label">
                              Enter Branch Policies
                            </label>
                            <div class="col-sm-10">
                                <CKEditor:CKEditorControl ID="txtBranchPolicies" runat="server" Height="300" required="" Toolbar="Basic">
