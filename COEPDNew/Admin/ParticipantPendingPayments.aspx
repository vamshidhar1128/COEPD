<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="ParticipantPendingPayments.aspx.cs" Inherits="Admin_ParticipantPendingPayments" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        $(document).ready(function ($) {
            ...
            ////var maxDate = new Date();  // Set maxDate to today
        ...
        <div class="col-lg-12 col-md-12">
            <div class="widget">
                <div class="widget-header">
                    <div class="title">
                        Participant Pending Installment Payments (before 15days)
                    </div>
                </div>
