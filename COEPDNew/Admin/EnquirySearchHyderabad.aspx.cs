...
public partial class Admin_EnquirySearchHyderabad : System.Web.UI.Page
{
    int Total = 0;
    ...
    protected void BindData()
    {
        ...
        List<clsEnquiryHyderabad> items = Obj.LoadAll(Obj);
        if (items != null)
        {
            Total = items.Count;
    ...
    protected void gv_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        //{
        //    Response.Redirect(".aspx?ItemId=" + e.CommandArgument);
        //}
