...
using BusinessLayer;
public partial class Admin_BatchTime : System.Web.UI.Page
{
    clsBatchTime Item;
    int ItemId = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Item = new clsBatchTime();
        if (!IsPostBack)
        {
            if (ItemId > 0)
            {
                lblTitle.Text = "Edit Batch Time";
            ...
            {
                lblTitle.Text = "Add New Batch Time";
            }
        }
    }
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        if (ItemId > 0)
        {
            Item.BatchTimeId = Convert.ToInt16(ItemId);
        }
        ...
        Item.AddUpdate(Item);
        Response.Redirect("BatchTimeSearch.aspx");
    }
