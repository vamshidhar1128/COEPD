<%@ Page Title="" Language="C#" MasterPageFile="Admin.master" AutoEventWireup="true"
    CodeFile="CorporateSearch.aspx.cs" Inherits="CorporateSearch" %>
                                ...
                                <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="150px">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEdit" runat="server" SkinID="edit" CommandName="cmdEdit"
                                            CommandArgument='<%#Eval("CorporateId")%>'></asp:LinkButton>
                                        <asp:LinkButton ID="lnkDelete" runat="server" SkinID="delete" CommandName="cmdDelete"
                                            CommandArgument='<%#Eval("CorporateId")%>' OnClientClick="return confirm('Are you sure you want to delete this BA Placements?');"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField HeaderText="SNo" DataField="SNo" ItemStyle-Width="50px" />
                                <asp:BoundField HeaderText="BA Placement Name" DataField="Corporate" />
                                ...
                                <asp:TemplateField HeaderText="Image">
                                    <ItemTemplate>
                                        <a href='../UserDocs/Corporate/<%#Eval("ImagePath")%>' target="_blank">
                                            <img src='../UserDocs/Corporate/<%#Eval("ImagePath")%>' alt='Gallery' width="50px" height="50px" />
                                        </a>
                                    </ItemTemplate>
