...
public partial class Admin_ProcessTeam : System.Web.UI.Page
{
    ...
    protected void BindData2()
    {
        ...
        if (employees != null)
        {
            ...
            if (filteredEmployees.Count > 0)
            {
                ...
                if (obj.LocationId == 1 || obj.LocationId == 2)
                {
    ...
    protected void BindData1()
    {
        ...
        if (employees != null)
        {
            ...
            foreach (var employee in employees)
            {
                ...
                if (employee.EmployeeId == 6312 || employee.EmployeeId == 6325 || employee.EmployeeId == 182)
                {
                    employee.Roles = "Team Lead";
                }
                else
