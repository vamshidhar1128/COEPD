<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="NurturingProcessStageSearch.aspx.cs" Inherits="Admin_NurturingProcessStageSearch" %>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="widget">
                            <div class="widget-header">
                                <div class="title">
                                    Nurturing Process Stages
                                </div>
                            </div>
                            <div class="widget-body">
                                <div class="Row">
                                    <div class="col-lg-2 col-md-2">
                                        <asp:TextBox runat="server" ID="txtNurturingProcessStageName" MaxLength="250" Placeholder="NurturingProcessStage Name" OnTextChanged="txtNurturingProcessStageName_TextChanged" AutoPostBack="True"></asp:TextBox>
                                    </div>
                                    <div class="col-lg-2 col-md-2">
                                ...
                                <div class="Row">
                                    <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false" PageSize="20" HeaderStyle-HorizontalAlign="Center" Width="100%" AllowPaging="true" OnRowCommand="gv_RowCommand" AllowSorting="true" OnPageIndexChanging="gv_PageIndexChanging" ShowHeaderWhenEmpty="true" EmptyDataText="No Records Found!" OnPreRender="gv_PreRender">
                                        ...
                                        <asp:LinkButton ID="lnkEdit" runat="server" SkinID="edit" CommandName="cmdEdit"
                                            CommandArgument='<%#Eval("NurturingProcessStageId")%>'></asp:LinkButton>
                                      <%--<asp:LinkButton ID="lnkDelete" runat="server" SkinID="delete" CommandName="cmdDelete"
                                            CommandArgument='<%#Eval("NurturingProcessStageId")%>' OnClientClick="return confirm('Are you sure you want to delete this Nurturing Process Stage?');"></asp:LinkButton>--%>
                                    </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
