...
public partial class Admin_HrChatSearch : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        ...
        if (txtHrProcessStageTask.Text != "")
            Item.HrProcessStageTaskName = txtHrProcessStageTask.Text;
    ...
    protected void gv_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("HrChat.aspx?ItemId=" + e.CommandArgument);
        }
    ...
    protected void txtHrProcessStageTask_TextChanged(object sender, EventArgs e)
    {
        BindData();
    }
