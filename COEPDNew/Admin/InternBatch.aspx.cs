...
public partial class InternBatch : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (ItemId > 0)
            {
                lblTitle.Text = "Edit Intern Batch";
            ...
            {
                lblTitle.Text = "Add New Intern Batch";
                DateTime dt;
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        if (ItemId > 0)
        {
            Item.InternBatchId = Convert.ToInt16(ItemId);
        }
        ...
        Item.AddUpdate(Item);
        Response.Redirect("InternBatchSearch.aspx");
    }
    protected void btnAddNew_Click(object sender, EventArgs e)
    {
        Response.Redirect("InternBatch.aspx");
    }
