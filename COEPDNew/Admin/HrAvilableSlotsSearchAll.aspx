<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="HrAvilableSlotsSearchAll.aspx.cs" Inherits="Admin_HrAvilableSlotsSearchAll" %>
                   ...
                   <%-- <div class="row">
                    ...
                    <div class="row">
                        <div class="table-responsive">
                            <asp:GridView ID="gv" runat="server" AutoGenerateColumns="False" Width="100%" PageSize="100" HeaderStyle-HorizontalAlign="Center" AllowPaging="true" AllowSorting="true" OnPageIndexChanging="gv_PageIndexChanging" OnRowCommand="gv_RowCommand" ShowHeaderWhenEmpty="true" EmptyDataText="No Records Found!" OnPreRender="gv_PreRender">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Action">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:LinkButton ID="lnkDelete" runat="server" SkinID="delete" Text="Delete Slot" CommandName="cmdDelete"
                                                CommandArgument='<%#Eval("HrProcessSlotsId")%>' Visible='<%#(Boolean.Parse(Eval("IsSlotAssigned").ToString()) ? false:true) %>' OnClientClick="return confirm('Are you sure you want to delete this Slot?');"></asp:LinkButton>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Change Slot">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkChangeSlot" runat="server" Text="Change Slot" CommandName="cmdChangeSlot"
                                                CommandArgument='<%#Eval("HrProcessSlotsId") %>' Visible='<%#(Boolean.Parse(Eval("IsSlotAssigned").ToString()) ? true:false) %>' OnClientClick="return confirm('Are you sure you want to Change this Slot?')"></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                                <EmptyDataTemplate>
