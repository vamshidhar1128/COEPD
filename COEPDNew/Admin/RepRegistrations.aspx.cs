...
using BusinessLayer;
public partial class RepRegistrations : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
           ...
           // BindData();
            ...
            gv.Caption = "Leads Reports Of " + txtFromDate.Text;
        }
    }
    ...
    protected void BindData()
    {
        if (ddlLocation.Items.Count > 0)
        {
            ...
            {
                gv.Caption = "  Leads Registration Reports Of " + ddlEmployee.SelectedItem + " From " + txtFromDate.Text + " To " + txtToDate.Text;
                gv.DataSource = obj.LoadAllRegistrationReport(obj);
                gv.DataBind();
            }
            else
            {
                gv.Caption = " Leads Registration Reports From " + txtFromDate.Text + " To " + txtToDate.Text;
                gv.DataSource = obj.LoadAllRegistrationReport(obj);
                gv.DataBind();
            }
        }
