...
{
    public class clsAssignNurturingTask
    {
        DataAccessLayerHelper.clsAssignNurturingTaskData DBLayer;
        ...
        public clsAssignNurturingTask()
        {
            DBLayer = new DataAccessLayerHelper.clsAssignNurturingTaskData();
        }
