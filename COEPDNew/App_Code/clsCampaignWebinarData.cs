...
{
    public class clsCampaignWebinarData
    {
        ...
        public void AddUpdate(clsCampaignWebinar obj)
        {
            ...
            {
                using (SqlCommand objCmd = new SqlCommand("WebinarCampaign_AddUpdate", objConn))
                {
                    objConn.Open();
        ...
        public clsCampaignWebinar Load(int Id)
        {
            using (SqlConnection objConn = new SqlConnection(Constr))
            {
                using (SqlCommand objCmd = new SqlCommand("WebinarCampaign_Get", objConn))
                {
                    objConn.Open();
                    objCmd.CommandType = CommandType.StoredProcedure;
                    ...
                    if (objDset.Tables.Count > 0)
                    {
                        ...
                        {
                            clsCampaignWebinar objInfo = new clsCampaignWebinar();
        ...
        public List<clsCampaignWebinar> LoadAll(clsCampaignWebinar obj)
        {
            using (SqlConnection objConn = new SqlConnection(Constr))
            {
                using (SqlCommand objCmd = new SqlCommand("WebinarCampaign__List", objConn))
                {
                    objConn.Open();
                    objCmd.CommandType = CommandType.StoredProcedure;
                    ...
                    if (objDset.Tables.Count > 0)
                    {
                        if (objDset.Tables[0].Rows.Count > 0)
                        {
                            List<clsCampaignWebinar> objList = new List<clsCampaignWebinar>();
