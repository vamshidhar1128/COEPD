...
namespace BusinessLayer
{
    ...
    public class clsBranchPolicies
    {
        DataAccessLayerHelper.clsBranchPoliciesData DBLayer;
        private int _SNO;
        private string _Keywords;
        private int? _PolicyId;
        private int _LocationId;
        private int _BranchId;
        private string _PolicyTitle;
        ...
        public clsBranchPolicies()
        {
            DBLayer = new DataAccessLayerHelper.clsBranchPoliciesData();
        }
