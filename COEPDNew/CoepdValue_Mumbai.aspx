<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CoepdValue_Mumbai.aspx.cs" Inherits="CoepdValue_Mumbai" %>
...
<head runat="server">
    ...
    <link rel="canonical" href="https://www.coepd.com/coepdvalue_Mumbai.html" />
                    ...
                    <div class="row col-xs-12 col-sm-12 col-md-7 col-lg-7 background">
                        ...
                        <div class="left-form-row">
                            <div class="left-title-page">
                                <h1>
                                    <asp:Label ID="lblTitle" Text="Business Analyst Training Mumbai" runat="server"> </asp:Label></h1>
                            </div>
