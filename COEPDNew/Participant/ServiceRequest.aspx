<%@ Page Title="" Language="C#" MasterPageFile="~/Participant/Participant.master" AutoEventWireup="true" CodeFile="ServiceRequest.aspx.cs" Inherits="Participant_ServiceRequest" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        function alertmeSave() {
            Swal.fire(
                      'Nurturing Service Desk received your request. Thanks. You will receive response in 24 working hours.',
                      '',
                      'success'
                    )
        }
        function alertmeDuplicate() {
            Swal.fire(
                        'Nurturing Service Desk aleardy received your request. Thanks. You will receive response in 24 working hours.',
                        '',
                        'warning'
                    )
        }
            ...
            <div class="widget">
                <div class="form-horizontal no-margin">
                    <div class="widget-header">
                        <div class="title">
                            Contact Nurturing Team (Service Request Minimum 100 characters)
                        </div>
                    </div>
