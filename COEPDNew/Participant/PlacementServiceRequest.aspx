<%@ Page Title="" Language="C#" MasterPageFile="~/Participant/Participant.master" AutoEventWireup="true" CodeFile="PlacementServiceRequest.aspx.cs" Inherits="Participant_PlacementServiceRequest" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
      <script type="text/javascript">
        function alertmeSave() {
            Swal.fire(
                      'BA Job market  Service Desk received your request. Thanks. You will receive response in 24 working hours.',
                      '',
                      'success'
                    )
        }
        function alertmeDuplicate() {
            Swal.fire(
                        'BA Job market  Service Desk aleardy received your request. Thanks. You will receive response in 24 working hours.',
                        '',
                        'warning'
                    )
        }
            ...
            <div class="widget">
                <div class="form-horizontal no-margin">
                    <div class="widget-header">
                        <div class="title">
                            Contact BA Job market  Team (Service Request Minimum 100 characters)
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12">
                            <asp:TextBox ID="txtChat" runat="server" required="" TextMode="MultiLine" Height="200px"
                                placeholder="Dear Placement Team, I (StudentName), of Batch (Batch date). Describe your Service Request." AutoPostBack="true" OnTextChanged="txtChat_TextChanged">
                            </asp:TextBox>
                ...
                <div class="form-horizontal no-margin">
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <asp:HiddenField ID="hdnPlacementServiceRequestId" runat="server" />
                 ...
                 <div class="widget">
                    ...
                    <div class="widget-body" style="height: 300px; overflow-y: scroll">
                        <div class="viewport">
                            <div class="overview">
                                <ul class="chats">
                                    <asp:Repeater ID="rpEscalation" runat="server" OnItemDataBound="rpEscalation_ItemDataBound">
                                        <ItemTemplate>
                                            <asp:HiddenField ID="hdnEscalationRoleId" runat="server" Value='<%# Eval("RoleId")%>' />
                                            <asp:Panel ID="pnlIn" runat="server" Visible="false">
                                                <li class="in">
                                                    <img class="avatar" alt="" src="../img/profile.png" />
                                                    <div class="message">
