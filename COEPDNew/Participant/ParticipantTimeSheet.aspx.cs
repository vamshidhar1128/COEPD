...
using BusinessLayer;
public partial class ParticipantTimeSheet : System.Web.UI.Page
{
    clsParticipantTimeSheet Item;
    int ItemId = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Item = new clsParticipantTimeSheet();
        if (!IsPostBack)
        {
            if (ItemId > 0)
            {
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        Item.NurturingId = 0;
        Item.AddUpdate(Item);
        Response.Redirect("ParticipantTimeSheetSearch.aspx");
    }
