...
public partial class Participant_HrServiceRequest : System.Web.UI.Page
{
    ...
    protected void BindTopOneServieRequest()
    {
        ...
        if (CurrentUser.CurrentParticipantId > 0)
        {
            ...
            if (item != null)
            {
                ...
                hdnNurturingChatId.Value = Convert.ToString(item.HrChatId);
    ...
    {
        clsHrChat NurturingChatCount = new clsHrChat();
        NurturingChatCount.ParticipantId = CurrentUser.CurrentParticipantId;
        CountNo = NurturingChatCount.LoadHrChatValidation(NurturingChatCount);
    }
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            ParticipantNurturingChat.HrProcessStageId = 10;
            ParticipantNurturingChat.HrProcessStageTaskId = 53;
