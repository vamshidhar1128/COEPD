<%@ Page Title="" Language="C#" MasterPageFile="~/Participant/Participant.master" AutoEventWireup="true" CodeFile="NormalParticipantTimeSheet.aspx.cs" Inherits="Participant_NormalParticipantTimeSheet" %>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-1 col-md-1" >
                                                <asp:DropDownList ID="DropDownList1" runat="server" Width="68px">
