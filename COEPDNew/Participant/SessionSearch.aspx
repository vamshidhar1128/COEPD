<%@ Page Title="" Language="C#" MasterPageFile="~/Participant/Participant.master" AutoEventWireup="true" CodeFile="SessionSearch.aspx.cs" Inherits="Participant_SessionSearch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function ($) {
            $("input[id$=txtupFromdate]").datepicker({
                dateFormat: 'dd/mm/yy',
                changeMonth: true,
                changeYear: true,
                changeprevious: true,
            ...
            $("input[id$=txtupTodate]").datepicker({
                dateFormat: 'dd/mm/yy',
                changeMonth: true,
                changeYear: true,
                /*maxDate: "+20",*/
            ...
            <div class="widget">
                ...
                <div class="widget-body">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <asp:TextBox ID="txtFromDate" runat="server" Placeholder="From Date" AutoPostBack="true" Visible="false" OnTextChanged="txtFromDate_TextChanged"></asp:TextBox>
                        </div>

                        <div class="col-md-2">
                            <asp:TextBox ID="txtToDate" runat="server" Placeholder="To Date" AutoPostBack="true" Visible="false" OnTextChanged="txtToDate_TextChanged"></asp:TextBox>
                        </div>
            ...
            <div class="widget">
                ...
                <div class="widget-body">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <asp:TextBox ID="txtupFromdate" runat="server" Placeholder="From Date" AutoPostBack="true" OnTextChanged="txtupFromdate_TextChanged" Visible="false"></asp:TextBox>
                        </div>

                        <div class="col-md-2">
                            <asp:TextBox ID="txtupTodate" runat="server" Placeholder="To Date" AutoPostBack="true" OnTextChanged="txtupTodate_TextChanged" Visible="false"></asp:TextBox>
                        </div>
                    ...
                    <div class="row">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" PageSize="100" HeaderStyle-HorizontalAlign="Center" Width="100%" AllowPaging="true" AllowSorting="true" OnRowCommand="GridView1_RowCommand" OnPageIndexChanging="GridView1_PageIndexChanging" ShowHeaderWhenEmpty="true" EmptyDataText="No Records Found!">
                            <Columns>
                                <asp:BoundField HeaderText="S.No" DataField="SNo" />
                                <asp:BoundField HeaderText="Session Name" DataField="TotalSession" />
                                <asp:BoundField HeaderText="Date" DataField="Date" DataFormatString="{0: dd MMM yyyy}" />
                                ...
                                <asp:TemplateField HeaderText="Status" ItemStyle-Width="150px">
                                    ...
                                    <ItemTemplate>
                                        <asp:HiddenField ID="hdnStatusId" runat="server" Value='<%#Eval("AttendId") %>' />
                                        <asp:Label ID="lbl" runat="server" />
                                        <asp:DropDownList ID="ddlAction" runat="server" OnSelectedIndexChanged="ddlAction_SelectedIndexChanged" ReadOnly="True" CommandName="ShowDetails" AutoPostBack="true" Visible="false">
                                            <asp:ListItem Text="Attend" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="Yes" Value="1"></asp:ListItem>
                                        </asp:DropDownList>
                                        <asp:Literal ID="ltrlMessage" runat="server"></asp:Literal>
