<%@ Page Title="" Language="C#" MasterPageFile="~/Participant/Participant.master" AutoEventWireup="true" CodeFile="Feedback.aspx.cs" Inherits="Participant_Feedback" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <script type="text/javascript">
        ...
        function alertmeDuplicate() {
            Swal.fire('Your Escalation already received Nurturing Team. Thanks. You will receive response in 24 working hours.',
                '',
                'warning'
                )
        }
