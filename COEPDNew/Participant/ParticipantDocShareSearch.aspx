<%@ Page Title="" Language="C#" MasterPageFile="~/Participant/Participant.master" AutoEventWireup="true"
    CodeFile="ParticipantDocShareSearch.aspx.cs" Inherits="ParticipantDocShareSearch" %>
                                ...
                                <%--<asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="100px">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEdit" runat="server" Text="Edit" SkinID="Edit" CommandName="cmdEdit"
                                            CommandArgument='<%#Eval("ParticipantDocumentId")%>'></asp:LinkButton>
                                        <asp:LinkButton ID="lnkDelete" runat="server" SkinID="delete" CommandName="cmdDelete"
                                            CommandArgument='<%#Eval("ParticipantDocumentId")%>' OnClientClick="return confirm('Are you sure you want to delete this Record?');"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>--%>
                                <asp:BoundField HeaderText="SNo" DataField="SNo" ItemStyle-Width="50px" />
                                <asp:BoundField HeaderText="Document Name" DataField="ParticipantDocument" />
                                <asp:TemplateField HeaderText="View" ItemStyle-Width="100px">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="hpl" runat="server" NavigateUrl='<%#"~/UserDocs/EmployeeDocument/"+ Eval("DocPath")%>'
                               ...
                               <%-- <asp:TemplateField HeaderText="View" ItemStyle-Width="100px">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkDownload" runat="server" Text="Download" CommandName="cmdDownload"
                                            CommandArgument='<%#Eval("ParticipantDocumentPath")%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>--%>
                            </Columns>
                            <EmptyDataTemplate>
